...
<script >
    export default{
        ...
        computed: {
            defineCor(){
                return "inline-flex items-center px-1 py-0.5 bg-"+(this.cor||"gray")+"-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-"+(this.cor||"gray")+"-700  active:bg-"+(this.cor||"gray")+"-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
            }
        }
    }
